          ...
          return ListView.separated(
            ...
            itemBuilder: (_, i) {
              ...
              return Card(
                ...
                child: ListTile(
                  leading: CircleAvatar(child: Text(c.judul.isNotEmpty ? c.judul[0] : '?')),
                  title: Text(c.judul),
...
class _CatatanFormPageState extends State<CatatanFormPage> {
  ...
  void initState() {
    ...
    final initialKategori = widget.initial?.kategori;
    if (initialKategori != null && _kategoriOpsi.contains(initialKategori)) {
      _kategori = initialKategori;
    } else {
      _kategori = 'Kuliah';
    }
  }
        ...
        child: ListView(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              initialValue: _kategori, // Menggunakan initialValue untuk Flutter baru
              decoration: const InputDecoration(
                labelText: 'Kategori',
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              final hasil = await Navigator.pushNamed(context, '/form', arguments: catatan);
